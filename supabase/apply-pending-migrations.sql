-- ============================================================================
-- Relevé Connect — APPLY PENDING MIGRATIONS (one paste, in order)
-- ----------------------------------------------------------------------------
-- Paste this whole file into the Supabase SQL Editor and Run.
--
-- Context: supabase/setup.sql (the base schema) was applied, but the two
-- migrations below were NOT. This applies them in the correct order:
--   1) Row-Level Security  — also defines owns_talent_profile(), which the
--      Stripe migration depends on. (This is why the Stripe migration failed.)
--   2) Stripe Connect / $499 Signature Experience.
--
-- Both migrations are idempotent (drop-if-exists / add-column-if-not-exists /
-- create-table-if-not-exists), so this is SAFE to run more than once.
--
-- This file is generated from, and identical to, the two files in
-- supabase/migrations/. It exists only for convenient one-paste application.
-- ============================================================================


-- ############################################################################
-- ## MIGRATION 1 of 2 — 20260702000000_enable_row_level_security.sql
-- ####################################################################### ####
-- ============================================================================
...
-- ####################################################################### ####
-- ## MIGRATION 2 of 2 — 20260708120000_stripe_connect_signature_experience.sql
-- ####################################################################### ####
-- ============================================================================
